...
import { fetchUnreadCount, SALVIA_APP_ID } from '@/lib/api/notificationApi'
...
export function Topbar({ accentColor, onToggleThemeSettings, onToggleTodoPanel }: TopbarProps) {
  ...
  useEffect(() => {
    ...
    fetchUnreadCount({ app_id: SALVIA_APP_ID, user_id: session.user.id })
      ...
      <div className="flex items-center justify-between h-full px-2 gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <DropdownMenu open={notificationOpen} onOpenChange={setNotificationOpen}>
            ...
            <DropdownMenuContent align="end" className="p-0 w-auto z-[100]">
              <NotificationPanel
